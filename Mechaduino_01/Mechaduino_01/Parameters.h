...
#define IN1_HIGH() (REG_PORT_OUTSET0 = PORT_PA06)
#define IN1_LOW() (REG_PORT_OUTCLR0 = PORT_PA06)
#define IN2_HIGH() (REG_PORT_OUTSET0 = PORT_PA21)
#define IN2_LOW() (REG_PORT_OUTCLR0 = PORT_PA21)
#define IN3_HIGH() (REG_PORT_OUTSET0 = PORT_PA15)
#define IN3_LOW() (REG_PORT_OUTCLR0 = PORT_PA15)
#define IN4_HIGH() (REG_PORT_OUTSET0 = PORT_PA20)
#define IN4_LOW() (REG_PORT_OUTCLR0 = PORT_PA20)
